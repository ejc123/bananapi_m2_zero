defmodule NervesSystemBananaPiM2.MixProject do
  use Mix.Project

  @github_organization "ejc123"
  @app :bananapi_m2_zero
...
#      {:nerves_toolchain_armv7_nerves_linux_gnueabihf, path: "../toolchains/nerves_toolchain_armv7_nerves_linux_gnueabihf/", runtime: false},
  ...
  defp description do
    "Nerves System - Banana Pi M2 Zero"
  end
